...
<div class="page-header">
    <h1>
        <i class="fa fa-edit"></i> Editar Especialidade
        <small>{{ $especialidade->nome }}</small>
    </h1>
</div>

<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <form method="POST" action="{{ route('especialidades.update', $especialidade->id) }}" id="especialidadeForm" class="no-loading">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" 
                                  ...
                                  rows="4"
                                  maxlength="500"
                                  placeholder="Descreva brevemente a especialidade (opcional)">{{ old('descricao', $especialidade->descricao) }}</textarea>
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" 
                                       name="ativa" 
                                       value="1" 
                                       {{ old('ativa', $especialidade->ativa) ? 'checked' : '' }}> 
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-lg" id="submitBtn">
                    <i class="fa fa-save"></i> Atualizar Especialidade
                </button>
                <a class="btn btn-default btn-lg" href="{{ route('especialidades.index') }}">
                    <i class="fa fa-arrow-left"></i> Cancelar
                </a>
                <a class="btn btn-info btn-lg" href="{{ route('especialidades.show', $especialidade->id) }}">
